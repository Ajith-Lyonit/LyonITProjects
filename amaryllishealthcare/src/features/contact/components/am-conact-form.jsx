...
export const AMContactForm = () => {
  const responsiveCheck = useDeviceType();
  const [tabChange, setTabChange] = useState("first");
  ...
  const [AMD_Followup, setAMD_Followup] = useState(true);
    ...
    if (errors.length > 0) {
      ...
      formData.append(
        ...
        JSON.stringify({
          ...
          AMD_SubjectType:
            tabChange === "first" ? subjectConfig.AMD_CONTACT_CATALOG : subjectConfig.AMD_HAVE_QUESTION,
        })
      );
      resetSupportValues();
      Swal.fire({
  ...
  return (
    <div className="container-fluid am-contact-l py-2">
      <h1 class="fa-2x py-3 fw-medium px-5 text-decoration-underline">Request for Catalog</h1>
        ...
        >
          <div className="row">
            ...
            {tabChange === 'first' && (
              <div className="col-lg-6">
                <div className="mb-3">
                  <label htmlFor="product-catalogue" className="form-label">Which product catalog are you interested in?*</label>
                  <select
                    className="w-100 am-custom-select"
            ...
            {tabChange === "first" && (
              <>
                <div className="col-lg-6">
                  <div className="">
                    <p style={{ fontSize: '0.9rem' }}>Would you like to schedule a follow-up discussion after receiving the catalog? *
                      <div className="mt-3">
                        <button
                          type="button"
                          className="am-contact-l-button"
                          style={{ backgroundColor: AMD_Followup ? 'lightblue' : '' }}
                          onClick={() => setAMD_Followup(true)}
                        >
                          Yes
                        </button>&nbsp;
                        <button
            ...
            {tabChange === 'first' && (
              <div className="col-lg-6">
                <div className="mb-3">
                  <label htmlFor="additional-details" className="form-label">Have any additional requests or details?</label>
                  <textarea
                    style={{ height: '5rem' }}
                    className="form-control"
