...
export default function TransferDoument({ route }: any) {
    ...
    const [tableData, setTableData] = useState([
        { sno: 1, code: 'I01252', item: "Poly Bag LDPE+PP Mix Transparent", qty: 10, recqty: 5 },
        { sno: 2, code: 'I01253', item: "Poly Bag LDPE+PP Mix Transparent", qty: 20, recqty: 10 },
        { sno: 3, code: 'I01254', item: "Poly Bag LDPE+PP Mix Transparent", qty: 20, recqty: 10 },
        { sno: 4, code: 'I01255', item: "Poly Bag LDPE+PP Mix Transparent", qty: 20, recqty: 10 },
        { sno: 5, code: 'I01256', item: "Poly Bag LDPE+PP Mix Transparent", qty: 20, recqty: 10 },
        { sno: 6, code: 'I01257', item: "Poly Bag LDPE+PP Mix Transparent", qty: 20, recqty: 10 },
    ]);
    ...
    const TableHeader = () => (
        <View style={styles.tableHeader}>
            ...
            <View style={styles.colQty}>
                <Text style={styles.headerText}>Qty. (Boxes)</Text>
            </View>
            <View style={styles.colRecQty}>
                <Text style={styles.headerText}>Rec. Qty. (Boxes)</Text>
            </View>
